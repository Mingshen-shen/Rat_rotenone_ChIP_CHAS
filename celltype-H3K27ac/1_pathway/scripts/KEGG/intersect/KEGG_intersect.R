...
bed_files <- c("~/Desktop/unique_peaks/NeuN_unique.bed",
               "~/Desktop/unique_peaks/Nurr_unique.bed",
               "~/Desktop/unique_peaks/Olig_unique.bed",
               "~/Desktop/unique_peaks/Neg_unique.bed")
